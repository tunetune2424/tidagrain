    ...
    <>
      ...
      <section className="max-w-[1100px] mx-auto px-4 sm:px-8 pb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-start">
          ...
          {/* 右：商品情報・購入ボタン */}
          <div className="pt-2">
            <p className="text-[12px] text-muted tracking-[0.08em] mb-3">
            ...
            <p className="text-[22px] mb-8 tracking-[0.04em]">
              ...
              <span className="text-[13px] text-muted">（税込）</span>
            </p>
            ...
            <div className="border-t border-border pt-7 mb-7">
              ...
              <button
                ...
                disabled={added}
                className={`w-full py-4 text-[14px] tracking-[0.1em] font-light transition-all duration-300 mb-3 ${
                  added
              ...
              <button className="w-full py-4 bg-transparent text-t-text text-[14px] tracking-[0.1em] font-light border border-border transition-colors duration-300 hover:border-t-text">
                ♡ &nbsp;お気に入りに追加
              </button>
            </div>
            ...
            {product.description && (
              <div className="border-t border-border pt-7">
                ...
                <p className="font-serif-jp text-[15px] leading-[2.4] text-muted2 whitespace-pre-line">
                  {product.description}
                </p>
              </div>
            )}
              ...
              {related.map((r) => (
                ...
                >
                  ...
                  <div className="px-[18px] py-4">
                    <p className="text-[12px] text-muted mb-1">{CATEGORY_LABEL[r.category] ?? r.category}</p>
                    <p className="text-[16px] font-normal mb-2">{r.name}</p>
                    <p className="text-[14px]">¥{r.price.toLocaleString()}</p>
                  </div>
                </Link>
              ))}
            </div>
